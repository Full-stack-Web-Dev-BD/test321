        ...
        <div className="social-icons-container">
          <div className="social-icons">
            <ul style={{ margin: '0', padding: '0' }} class="d-flex ">
              ...
              <a style={{ color: 'transparent' }} href="https://web.facebook.com/N-X-T-G-E-M-110573431436306" class="ml-auto"> <img src="/files/meta.png" style={{ width: '40px', borderRadius: '7px', color: 'white', margin: '0 10px' }} alt="img" /></a>
